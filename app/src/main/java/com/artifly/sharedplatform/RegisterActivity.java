...
public class RegisterActivity extends AppCompatActivity {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { // 액티비티 시작시 실행되는 생명주기!
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success) {
                                ...
                                Intent intent = new Intent(com.artifly.sharedplatform.RegisterActivity.this, LoginActivity.class);
