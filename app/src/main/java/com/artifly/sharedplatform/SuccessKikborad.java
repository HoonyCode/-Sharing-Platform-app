        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Thread t = new Thread(){
                    ...
                    public void run() {
                        try {
                            URL url = new URL("http://192.168.1.97:8080/api/startShare?ccp=share1&id=" + userId + "&location=" + location + "&longitude=" + longitude + "&latitude=" + latitude + "&target=" + target);
                            ...
                            if(result.equals("success")){
                                ...
                                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                                    SuccessKikborad.this.startForegroundService(intent2);
                                } else {
                                    SuccessKikborad.this.startService(intent2);
                                }
                            }
                            else{
                                Log.e("adsf", "실패!");
